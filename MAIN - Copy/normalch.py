...
def normal():  # function to run discharge and charge cycles
    print('Normal Cycle Launched Successfully !!')
    ...
    ("discharge at 0.8 A until 2.5V", # discharging by default
     "rest for 15 minute",
    ...
    for i in range(0,n):
        ...
        ("discharge at 0.8A until 2.5V", # discharging by default
         "rest for 15 minute",
         f"charge at {2}A until 4.2V",
         "hold at 4.2V until C/50",
         "rest for 15 minute",)])
